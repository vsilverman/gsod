...
This repo shows a list of resources, required to complete a GSoD-2020 application

## Google Docs

- [Creating Tech Writing Application](https://developers.google.com/season-of-docs/docs/tech-writer-application-hints)

- [Tech Writing Guide](https://developers.google.com/season-of-docs/docs/tech-writer-guide)

- [Tech Writing Application Form](https://bit.ly/gsod-tw-app)
...
- [Config as code for K8S](https://github.com/vsilverman/configuration-as-code-jenkins-k8s)
